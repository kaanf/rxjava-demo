...
class PopularMoviePagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class MovieItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        var movieTitle: TextView = view.findViewById(R.id.cv_movie_title)
        var moviePoster: ImageView = view.findViewById(R.id.cv_iv_movie_poster)
        var movieYear: TextView = view.findViewById(R.id.movie_release_date)
